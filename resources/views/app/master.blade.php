...
<body>
            ...
            <div class="brand-logo">
                <a href="{{ url('/home') }}">
                    ...
                    <span class="brand-title">
                        ...
                        <span class="text-white ml-2"><b>Si Bela </span>
        ...
        <div class="header" style="background: transparent;">    
            <div class="header-content clearfix">
                ...
                <div class="nav-control">
                    ...
                    <span class><b>Sistem Pertanggung Jawaban Belanja Daerah</b> </span>
                </div>
    ...
    <div class="footer">
        <div class="copyright">
            <p>Copyright &copy; Aplikasi Keuangan Menggunakan Laravel. by. Helmi Iskandar</a> {{ date('Y') }}</p>
        </div>
    </div>
</div>
